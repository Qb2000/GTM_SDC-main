...
char science_csv_pipeline_column_name[] = "GTM ID;Day of Year;Hour;Minute;Second;Subsecond;X;Y;Z;Q1;Q2;Q3;Q4;Temperature;PPS;Fine Time;CITIROC;Channel;Gain;ADC;Sequence Number\n";
//= "GTM ID;Day of Year;Hour;Minute;Second;Subsecond;X;Y;Z;Vx;Vy;Vz;Q1;Q2;Q3;Q4;PPS;Fine Time;CITIROC;Channel;Gain;ADC\n";
        ...
        case 2:
            if (export_mode == 1) {
                ...
                if (ftell(raw_output_file) == 0) {
                    ...
                    fprintf(raw_output_file, "sync attitude: x; y; z; q_1; q_2; q_3; q_4; T \n"); //v_x; v_y; v_z;
...
void export_science_pipeline_output() {
    if (export_mode == 2 || export_mode == 3) {
        ...
        if (science_buffer->gtm_id == 0) { // master
            ...
            science_buffer->master_sync_temperature);
            ...
            //sequence number
            fprintf(science_pipeline_output_file, ";%u\n", science_buffer->master_sync_cmd_sequence_number);
        }
        else { // slave
            fprintf(science_pipeline_output_file, "%u", science_buffer->gtm_id);
            ...
            science_buffer->slave_sync_temperature);
            ...
            science_buffer->event_adc_citiroc_id, science_buffer->event_adc_channel_id, science_buffer->event_adc_gain, science_buffer->event_adc_adc_value);
            //sequence number
            fprintf(science_pipeline_output_file, ";%u\n", science_buffer->slave_sync_cmd_sequence_number);
        }
    }
}
...
void parse_science_sync_attitude(unsigned char *target) {
    ...
    if (science_buffer->gtm_id == 0) { // master
        ...
        // quaternion
        memcpy(&(science_buffer->master_sync_quaternion_1), target+12, 4);
        simple_big2little_endian(&(science_buffer->master_sync_quaternion_1), 4);
        memcpy(&(science_buffer->master_sync_quaternion_2), target+16, 4);
        simple_big2little_endian(&(science_buffer->master_sync_quaternion_2), 4);
        memcpy(&(science_buffer->master_sync_quaternion_3), target+20, 4);
        simple_big2little_endian(&(science_buffer->master_sync_quaternion_3), 4);
        memcpy(&(science_buffer->master_sync_quaternion_4), target+24, 4);
        simple_big2little_endian(&(science_buffer->master_sync_quaternion_4), 4);

        // Temperature
        memcpy(&(science_buffer->master_sync_temperature), target+28, 4);
        simple_big2little_endian(&(science_buffer->master_sync_temperature), 4);
    }
    else { // slave
        ...
        // quaternion
        memcpy(&(science_buffer->slave_sync_quaternion_1), target+12, 4);
        simple_big2little_endian(&(science_buffer->slave_sync_quaternion_1), 4);
        memcpy(&(science_buffer->slave_sync_quaternion_2), target+16, 4);
        simple_big2little_endian(&(science_buffer->slave_sync_quaternion_2), 4);
        memcpy(&(science_buffer->slave_sync_quaternion_3), target+20, 4);
        simple_big2little_endian(&(science_buffer->slave_sync_quaternion_3), 4);
        memcpy(&(science_buffer->slave_sync_quaternion_4), target+24, 4);
        simple_big2little_endian(&(science_buffer->slave_sync_quaternion_4), 4);

        // Temperature
        memcpy(&(science_buffer->slave_sync_temperature), target+28, 4);
        simple_big2little_endian(&(science_buffer->slave_sync_temperature), 4);
    }
}
...
void write_science_sync_data() {
    ...
    if (science_buffer->gtm_id == 0) { // for master
        if (export_mode == 1 || export_mode == 3) {
            ...
            fprintf(raw_output_file, "%10f; %10f; %10f;", \
            science_buffer->master_sync_x, science_buffer->master_sync_y, science_buffer->master_sync_z);
            // fprintf(raw_output_file, "%10u; %10u; %10u;", \
            // science_buffer->master_sync_v_x, science_buffer->master_sync_v_y, science_buffer->master_sync_v_z);
            fprintf(raw_output_file, "%5f; %5f; %5f; %5f;", \
            science_buffer->master_sync_quaternion_1, science_buffer->master_sync_quaternion_2, science_buffer->master_sync_quaternion_3, science_buffer->master_sync_quaternion_4);

            fprintf(raw_output_file, "%10f\n", \
            science_buffer->master_sync_temperature);
        }
    }
    else { // for slave
