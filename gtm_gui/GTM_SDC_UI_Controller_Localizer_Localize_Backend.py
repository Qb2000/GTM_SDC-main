...
def localize_grb(trigger_info):
    ...
    ax2.set_xlim((np.min((np.array(cs2.get_paths()[2].to_polygons())[0][:,0]))), np.max(((cs2.get_paths()[2].to_polygons())[0][:,0])))
    # ax2.set_ylim((np.min(((cs2.collections[2].get_paths()[0].to_polygons())[0][:,1]))), np.max(((cs2.collections[2].get_paths()[0].to_polygons())[0][:,1])))
    ax2.set_ylim((np.min(((cs2.get_paths()[2].to_polygons())[0][:,1]))), np.max(((cs2.get_paths()[2].to_polygons())[0][:,1])))
