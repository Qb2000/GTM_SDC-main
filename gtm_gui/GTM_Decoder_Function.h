...
typedef struct Science {
    ...
    float         master_sync_quaternion_1;
    float         master_sync_quaternion_2;
    float         master_sync_quaternion_3;
    float         master_sync_quaternion_4;
    float         master_sync_temperature;
    ...
    float         slave_sync_quaternion_1;
    float         slave_sync_quaternion_2;
    float         slave_sync_quaternion_3;
    float         slave_sync_quaternion_4;
    float         slave_sync_temperature;
